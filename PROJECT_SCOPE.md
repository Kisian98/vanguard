...
The AI should function as an onboard operator rather than a general desktop assistant.
...
The AI should never replace the operating system or become required for normal desktop use.
